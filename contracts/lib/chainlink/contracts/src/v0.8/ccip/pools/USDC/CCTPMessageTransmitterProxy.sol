...
contract CCTPMessageTransmitterProxy is Ownable2StepMsgSender {
    ...
    constructor(ITokenMessenger tokenMessenger) {
    ...
    function configureAllowedCallers(AllowedCallerConfigArgs[] calldata configArgs) external onlyOwner {
    ...
    function isAllowedCaller(address caller) external view returns (bool allowed) {
