...
contract SiloedLockReleaseTokenPool is TokenPool, ITypeAndVersion {
    ...
    function getAvailableTokens(uint64 remoteChainSelector) external view returns (uint256 lockedTokens) {
    ...
    function getChainRebalancer(uint64 remoteChainSelector) public view returns (address) {
