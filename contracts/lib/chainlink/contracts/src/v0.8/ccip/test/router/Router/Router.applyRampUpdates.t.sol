...
contract Router_applyRampUpdates is BaseTest {
    ...
    function testFuzz_applyRampUpdates_OffRampUpdates(address[20] memory offRampsInput) public {
    ...
    function testFuzz_applyRampUpdates_OnRampUpdates(Router.OnRamp[] memory onRamps) public {
        // Test adding onRamps
