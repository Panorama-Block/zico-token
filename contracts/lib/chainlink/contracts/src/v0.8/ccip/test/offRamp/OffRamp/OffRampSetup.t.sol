...
contract OffRampSetup is FeeQuoterSetup, MultiOCR3BaseSetup {
    ...
    function _generateAny2EVMMessageWithMaybeRevertingSingleToken(uint64 sequenceNumber, uint256 amount)
        internal
        view
        returns (Internal.Any2EVMRampMessage memory)
    {
    ...
    function _generateBatchReportFromMessages(uint64 sourceChainSelector, Internal.Any2EVMRampMessage[] memory messages)
        internal
        pure
        returns (Internal.ExecutionReport[] memory)
    {
