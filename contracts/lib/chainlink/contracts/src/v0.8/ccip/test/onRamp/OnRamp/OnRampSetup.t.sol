...
contract OnRampSetup is FeeQuoterFeeSetup {
    ...
    function _svmMessageToEvent(
        ...
        Client.SVMExtraArgsV1 memory extraArgs = s_feeQuoter.parseSVMExtraArgsFromBytes(
            message.extraArgs, s_feeQuoter.getDestChainConfig(DEST_CHAIN_SELECTOR)
        );
    ...
    function _deployOnRamp(uint64 sourceChainSelector, IRouter router, address nonceManager, address tokenAdminRegistry)
        internal
        returns (OnRampHelper, bytes32 metadataHash)
    {
