...
contract EtherSenderReceiverTest_validatedMessage is EtherSenderReceiverTestSetup {
    ...
    function testFuzz_validatedMessage_msgSenderOverwrite(bytes memory data) public view {
    ...
    function testFuzz_validatedMessage_tokenAddressOverwrite(address token) public view {
        Client.EVMTokenAmount[] memory tokenAmounts = new Client.EVMTokenAmount[](1);
