...
contract WorkflowRegistry is Ownable2StepMsgSender, ITypeAndVersion {
    ...
    function updateAuthorizedAddresses(address[] calldata addresses, bool allowed)
        external
        onlyOwner
        registryNotLocked
    {
    ...
    function _getWorkflowFromStorage(address sender, bytes32 workflowKey)
        internal
        view
        returns (WorkflowMetadata storage workflow)
    {
    ...
    function _requireUniqueWorkflowID(bytes32 workflowID) internal {
    ...
    function getWorkflowMetadata(address workflowOwner, string calldata workflowName)
        external
        view
        returns (WorkflowMetadata memory)
    {
    ...
    /// the specified owner.
    function getWorkflowMetadataListByOwner(address workflowOwner, uint256 start, uint256 limit)
        external
        view
        returns (WorkflowMetadata[] memory workflowMetadataList)
    {
    ...
    function getWorkflowMetadataListByDON(uint32 donID, uint256 start, uint256 limit)
        external
        view
        returns (WorkflowMetadata[] memory workflowMetadataList)
    {
    ...
    function _validateWorkflowURLs(uint256 binaryURLLength, uint256 configURLLength, uint256 secretsURLLength)
        internal
        pure
    {
