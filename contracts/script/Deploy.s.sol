...
contract DeployScript is Script {
    function run() external {
        ...
        bytes32 keyHash =
            _getEnvBytes32("VRF_KEYHASH", 0x354d2f95da55398f44b7cff77da56283d9c6c829a4bdf1bbcaf2ad6a4d081f61);
        ...
        TreasuryVault treasury = new TreasuryVault(address(zicoToken), linkToken, timelock);
        console.log("   TreasuryVault deployed:", address(treasury));

        console.log("3. Deploying ZicoStaking...");
        ZicoStakingShares staking = new ZicoStakingShares(address(zicoToken), timelock);
        console.log("   ZicoStaking deployed:", address(staking));

        console.log("4. Deploying ZicoRaffle...");
        ZicoRaffle raffle =
            new ZicoRaffle(vrfCoordinator, address(zicoToken), address(treasury), keyHash, subscriptionId);
        ...
        ProofOfReserve proofOfReserve = new ProofOfReserve(timelock, chainSelectors);
